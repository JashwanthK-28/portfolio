    ...
    <div className="min-h-screen bg-dark">
      ...
      <section className="py-16 max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto gap-6">
          ...
          <p className="text-muted leading-relaxed">
            Hi! I'm Jashwanth Kumar, a passionate MERN Stack Developer
            currently pursuing my B.Tech in Computer Science and Engineering.
            I have a deep love for crafting beautiful, user-centric digital
            experiences that leave a lasting impression.
          </p>
          <p className="text-muted leading-relaxed">
            My journey started with curiosity about how websites work, and it
            quickly evolved into a full-fledged passion for design systems,
            component architecture, and performance optimization. I spend my
            time building real-world projects, and constantly sharpening my
            skills.
          </p>
          <p className="text-muted leading-relaxed">
            When I'm not coding, you'll find me binge-watching tech talks, or
            experimenting with the latest JavaScript frameworks.
          </p>
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            {timeline.map((item, i) => (
              ...
              >
                ...
                {/* Content */}
                <div
                  className={`pl-8 md:pl-0 md:w-1/2 ${i % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"}`}
                >
                  <span className="text-accent font-mono text-xs mb-2 block">
                    {item.year}
                  </span>
                  <h3 className="text-lg font-display tracking-wider mb-1">
                    {item.title}
                  </h3>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-display tracking-wider">
            MY TECH STACK
          </h2>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
          {techIcons.map((tech) => (
            <GlareHover
              ...
              className="p-4 flex flex-col justify-center items-center gap-3 group hover:border-accent/50 card-hover transition-all duration-300"
            >
              <span className="text-3xl group-hover:scale-125 transition-transform duration-300 pointer-events-none">
                {tech.icon}
              </span>
              <span className="text-xs text-muted uppercase tracking-wider group-hover:text-light transition-colors pointer-events-none">
                {tech.name}
              </span>
            </GlareHover>
          ))}
